...
public class SurveyJobService extends JobService {
    ...
    public boolean onStartJob(JobParameters params) {
        ...
        postToken("http://54.180.29.63/api/user/check", "POST");
    ...
    public void postToken(String url, String method){
        ...
        class dataJson extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String result){
                ...
                if(getUserJSON != null) {
                    parseUserJSON();
                    getUserINO("http://54.180.29.63/api/user/wallet", "POST");
                    getSurveyFormJson("http://54.180.29.63/api/response/index", "POST", jobParams);
                }
            }
        }
